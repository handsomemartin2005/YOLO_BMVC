...
class DistanceCalculation:
    ...
    def __init__(
        ...
        Args:
            ...
            line_thickness (int, optional): Thickness of the lines drawn on the images. Defaults to 2.
            line_color (tuple, optional): Color of the lines drawn on the images (BGR format). Defaults to (255, 255, 0).
            centroid_color (tuple, optional): Color of the centroids drawn (BGR format). Defaults to (255, 0, 255).
        """
        # Visual & images information
        self.im0 = None
        self.annotator = None
