...
class ParkingPtsSelection:
    ...
    def __init__(self):
        ...
        # Setup canvas for images display
        ...
        self.current_box = []
        self.imgw = 0  # images width
        self.imgh = 0  # images height
    ...
    def upload_image(self):
        """Upload an images and resize it to fit canvas."""
        ...
        # Calculate the aspect ratio and resize images
    ...
    def remove_last_bounding_box(self):
        ...
        if self.rg_data:
            ...
            self.canvas.create_image(0, 0, anchor=self.tk.NW, image=self.canvas_image)  # Redraw the images
    ...
    def save_to_json(self):
        """Saves rescaled bounding boxes to 'bounding_boxes.json' based on images-to-canvas size ratio."""
        from tkinter import messagebox  # scope for multi-environment compatibility
