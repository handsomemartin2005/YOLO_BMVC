...
def _scale_bounding_box_to_original_image_shape(box, resized_image_shape, original_image_shape, ratio_pad):
    """
    YOLOv8 resizes images during training and the labels values are normalized based on this resized shape.
...
def _format_prediction_annotations_for_detection(image_path, metadata, class_label_map=None):
    ...
    for prediction in predictions:
        ...
        data.append({"boxes": [boxes], "labels": cls_label, "score": score})
...
def _log_plots(experiment, trainer):
    """Logs evaluation plots and labels plots for the experiment."""
