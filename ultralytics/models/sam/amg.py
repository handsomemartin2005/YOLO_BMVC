...
def build_point_grid(n_per_side: int) -> np.ndarray:
    """Generate a 2D grid of evenly spaced points in the range [0,1]x[0,1] for images segmentation tasks."""
...
def generate_crop_boxes(
    ...
    """Generates crop boxes of varying sizes for multi-scale images processing, with layered overlapping regions."""
...
def remove_small_regions(mask: np.ndarray, area_thresh: float, mode: str) -> Tuple[np.ndarray, bool]:
    ...
    sizes = stats[:, -1][1:]  # Row 0 is background labels
