...
class SAMModel(nn.Module):
    ...
    Attributes:
        ...
        pixel_mean (torch.Tensor): Mean pixel values for images normalization, shape (3, 1, 1).
        pixel_std (torch.Tensor): Standard deviation values for images normalization, shape (3, 1, 1).
...
class SAM2Model(torch.nn.Module):
    ...
    def _forward_sam_heads(
        ...
        if point_inputs is not None:
            ...
            # If no points are provide, pad with an empty point (with labels -1)
