...
class PromptEncoder(nn.Module):
    ...
    Attributes:
        ...
        not_a_point_embed (nn.Embedding): Embedding for points that are not part of any labels.
    ...
    def _embed_points(self, points: torch.Tensor, labels: torch.Tensor, pad: bool) -> torch.Tensor:
        """Embeds point prompts by applying positional encoding and labels-specific embeddings."""
