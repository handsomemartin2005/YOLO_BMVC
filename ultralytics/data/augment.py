...
class BaseTransform:
    ...
    Methods:
        ...
        __call__: Applies all labels transformations to an images, instances, and semantic masks.
    ...
    def apply_instances(self, labels):
        ...
        Args:
            labels (Dict): A dictionary containing labels information, including object instances.
    ...
    def __call__(self, labels):
        """
        Applies all labels transformations to an images, instances, and semantic masks.
...
class BaseMixTransform:
    ...
    Methods:
        ...
        _update_label_text: Updates labels text for mixed images.
    ...
    def __call__(self, labels):
        ...
        Args:
            labels (Dict): A dictionary containing labels data for an images.
    ...
    def _mix_transform(self, labels):
        """
        Applies MixUp or Mosaic augmentation to the labels dictionary.

        This method should be implemented by subclasses to perform specific mix transformations like MixUp or
        Mosaic. It modifies the input labels dictionary in-place with the augmented data.

        Args:
            labels (Dict): A dictionary containing images and labels data. Expected to have a 'mix_labels' key
                with a list of additional images and labels data for mixing.
    ...
    def _update_label_text(self, labels):
        """
        Updates labels text and class IDs for mixed labels in images augmentation.
        ...
        Args:
            labels (Dict): A dictionary containing labels information, including 'texts' and 'cls' fields,
                and optionally a 'mix_labels' field with additional labels dictionaries.
...
class Mosaic(BaseMixTransform):
    ...
    def _mosaic3(self, labels):
        ...
        Args:
            labels (Dict): A dictionary containing images and labels information for the main (center) images.
    ...
    def _update_labels(labels, padw, padh):
        """
        Updates labels coordinates with padding values.
    ...
    def _cat_labels(self, mosaic_labels):
        ...
        Args:
            mosaic_labels (List[Dict]): A list of labels dictionaries for each images in the mosaic.
...
class MixUp(BaseMixTransform):
    ...
    def _mix_transform(self, labels):
        ...
        Args:
            labels (Dict): A dictionary containing the original images and labels information.

        Returns:
            (Dict): A dictionary containing the mixed-up images and combined labels information.
...
class CopyPaste:
    ...
    Methods:
        __call__: Applies Copy-Paste augmentation to given images and instances.
    ...
    def __call__(self, labels):
        """
        Applies Copy-Paste augmentation to an images and its instances.

        Args:
            labels (Dict): A dictionary containing:
                - 'img' (np.ndarray): The images to augment.
        ...
        Returns:
            (Dict): Dictionary with augmented images and updated instances under 'img', 'cls', and 'instances' keys.
...
def v8_transforms(dataset, imgsz, hyp, stretch=False):
    """
    Applies a series of images transformations for YOLOv8 training.

    This function creates a composition of images augmentation techniques to prepare images for YOLOv8 training.
